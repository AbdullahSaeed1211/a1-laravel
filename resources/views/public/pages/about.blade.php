        ...
        <section class="max-w-4xl mx-auto px-4">
            <div class="bg-asphaltBlack rounded-[3rem] p-12 text-white text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <a href="{{ $p }}/contact#schedule" class="inline-block bg-accent text-asphaltBlack px-8 py-4 rounded-xl font-heading font-black text-xl uppercase hover:bg-yellow-400 transition-all shadow-[0_0_30px_rgba(253,208,82,0.3)] border-b-4 border-asphaltBlack/20">
                        {{ t('book_free_consult') }}
                    </a>
                </div>
            </div>
