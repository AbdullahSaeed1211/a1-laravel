    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6">
        <div class="flex items-center justify-between h-16 md:h-20">
            ...
            <div class="hidden lg:flex items-center gap-8">
                ...
                <a href="{{ $localePrefix }}/contact#schedule" class="bg-accent text-black px-6 py-2.5 rounded-full font-heading font-bold text-xs uppercase tracking-widest hover:bg-accent/90 transition-all">
                    {{ t('free_consult') }}
                </a>
            </div>
    ...
    <div x-show="mobileOpen"
        ...
        <div class="h-screen px-4 py-6 space-y-4 overflow-y-auto" style="background: #000;">
            ...
            <div class="pt-4 border-t border-white/5 space-y-3">
                ...
                <a href="{{ $localePrefix }}/contact#schedule" class="block bg-accent text-black px-4 py-3 rounded-full text-xs font-bold uppercase tracking-widest text-center font-heading">{{ t('free_consult') }}</a>
            </div>
        </div>
    </div>
</nav>
