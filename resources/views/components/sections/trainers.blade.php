    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ $p }}/trainers/{{ $trainer['slug'] }}"
               class="{{ $idx === 0 ? 'md:col-span-2 lg:col-span-2 lg:row-span-2 aspect-[4/5] md:aspect-[16/10] lg:aspect-auto' : 'aspect-[4/5]' }} group relative rounded-[40px] overflow-hidden border border-white/5 hover:border-accent/40 transition-all duration-700 shadow-2xl block">
                <img src="{{ $trainerImg }}" alt="{{ $trainer['name'] }}" class="w-full h-full object-cover object-top origin-top grayscale group-hover:grayscale-0 group-hover:scale-[1.02] transition-all duration-700">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
            ...
            @endphp
            <a href="{{ $p }}/trainers/{{ $trainer['slug'] }}"
               class="aspect-[4/5] group relative rounded-[40px] overflow-hidden border border-white/5 hover:border-accent/40 transition-all duration-700 shadow-2xl block">
                <img src="{{ $trainerImg }}" alt="{{ $trainer['name'] }}" class="w-full h-full object-cover object-top origin-top grayscale group-hover:grayscale-0 group-hover:scale-[1.02] transition-all duration-700">
                <div class="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent opacity-90 group-hover:opacity-70 transition-opacity"></div>
